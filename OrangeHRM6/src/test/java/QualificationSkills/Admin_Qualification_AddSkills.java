...
public class Admin_Qualification_AddSkills
{
	...
	{  
		ExcelApiTest3 eat = new ExcelApiTest3();
		 ...
		 int numberowsInputdata=eat.getRowCount("E://OrangeHrm//TC03_skills.xls","Sheet1");
		 System.out.println("numberowsInputdata..." + numberowsInputdata);
			 ...
			 {		 
				 ...
				 UserName=eat.getCellData("E://OrangeHrm//TC03_skills.xls","Sheet1",i,0);
				 Password=eat.getCellData("E://OrangeHrm//TC03_skills.xls","Sheet1",i,1);
				 System.out.println("User name is"+UserName);
				 System.out.println(" Password is "+Password);
				 
				 Skill_Name=eat.getCellData("E://OrangeHrm//TC03_skills.xls","Sheet1",i,2);
				 Skill_Description=eat.getCellData("E://OrangeHrm//TC03_skills.xls","Sheet1",i,3);
