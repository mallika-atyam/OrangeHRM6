...
public class Admin_Skils_Export
{
	...
	{  
			 ...
			 int numberowsInputdata=eat.getRowCount("E://OrangeHrm//TC03_Skills.xls","Sheet4");

				 for(int i=1;i<2;i++)
				 {		 
					 UserName=eat.getCellData("E://OrangeHrm//TC03_Skills.xls","Sheet4",i,0);
					 Password=eat.getCellData("E://OrangeHrm//TC03_Skills.xls","Sheet4",i,1);
					 System.out.println("User name is"+UserName);
					 System.out.println(" Password is "+Password);
					
					 Skill_Name=eat.getCellData("E://OrangeHrm//TC03_Skills.xls","Sheet4",i,2);
					 System.out.println(" Skill_Name is "+Skill_Name);
					 
					 Skill_Description=eat.getCellData("E://OrangeHrm//TC03_Skills.xls","Sheet4",i,3);
							    	  ...
							    	  for ( int j=2 ,k=0; j<=columns.size() ;j++,k++)
							    	   {
							      		...
							      		//*[@id='recordsListTable']/thead/tr/th
							    	        ...
							    	        if (valueIneed1 !=null)
							    	        eat.PutCellData( "E://OrangeHrm//TC03_Skills.xls","Sheet5",i,k,valueIneed1);
							    	        else
							    	        eat.PutCellData( "E://OrangeHrm//TC03_Skills.xls","Sheet5",i,k,"Blank Data");
