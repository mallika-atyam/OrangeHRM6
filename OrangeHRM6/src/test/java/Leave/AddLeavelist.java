...
public class AddLeavelist
{
	...
	public String EmpName,LeaveType,Fday,Fmon,Fyear,Tyear,Tmon,Tday,Comment;
	...
	{  
		  ...
		  int numberowsInputdata=eat.getRowCount("C://HTML Report//OrangeHRM6//TC01_Leavelist.xls","Sheet1");
				 ...
				 {		 
					 ...
					 Comment=eat.getCellData("C://HTML Report//OrangeHRM6//TC01_Leavelist.xls","Sheet1",i,2);
					 Fyear=eat.getCellData("C://HTML Report//OrangeHRM6//TC01_Leavelist.xls","Sheet1",i,3);
					 Fmon=eat.getCellData("C://HTML Report//OrangeHRM6//TC01_Leavelist.xls","Sheet1",i,4);
					 Fday=eat.getCellData("C://HTML Report//OrangeHRM6//TC01_Leavelist.xls","Sheet1",i,5);
					 Tyear=eat.getCellData("C://HTML Report//OrangeHRM6//TC01_Leavelist.xls","Sheet1",i,6);
					 Tmon=eat.getCellData("C://HTML Report//OrangeHRM6//TC01_Leavelist.xls","Sheet1",i,7);
					 Tday=eat.getCellData("C://HTML Report//OrangeHRM6//TC01_Leavelist.xls","Sheet1",i,8);
	...
	{  
		...
		ALL.LeaveAssign(iRow, EmpName,LeaveType,Fyear,Fmon,Fday,Tyear,Tmon,Tday,Comment);
	...
	public   void LeaveAssign(int iRow,String EmpName,String LeaveType,String Fyear,String Fmon,String Fday,String Tyear,String Tmon,String Tday,String Coment )throws Exception
	{  
...
/*
	 	driver.findElement(By.xpath(OR.LAfrdtpicker)).click();
	 	 Select listbox1 =new Select(driver.findElement(By.xpath(OR.LAfryear)));
	 	 listbox1.selectByVisibleText(Fyear);
	 	Select listbox2 =new Select(driver.findElement(By.xpath(OR.LAfrmon)));
	 	 listbox2.selectByVisibleText(Fmon);
	 	Select listbox3 =new Select(driver.findElement(By.xpath(OR.LAfrday)));
	 	 listbox3.selectByVisibleText(Fday);
	 	 
	 	 
	 	driver.findElement(By.xpath(OR.LAtodtpicker)).click();
	 	 Select listbox4 =new Select(driver.findElement(By.xpath(OR.LAtoyear)));
	 	 listbox4.selectByVisibleText(Tyear);
	 	Select listbox5 =new Select(driver.findElement(By.xpath(OR.LAtomon)));
	 	 listbox5.selectByVisibleText(Tmon);
	 	Select listbox6 =new Select(driver.findElement(By.xpath(OR.LAtoday)));
	 	 listbox6.selectByVisibleText(Tday);
	 	 */
		...
		driver.findElement(By.xpath(OR.LE_Fromdate_sendkey)).clear();
		driver.findElement(By.xpath(OR.LE_Fromdate_sendkey)).sendKeys(date1);
		...
		driver.findElement(By.xpath(OR.LAtodtpicker)).click(); 
		 ...
		 driver.findElement(By.xpath(OR.LE_Todate_sendkey)).sendKeys(date1);
		 //TH3.HTMLScreenShot("Enter ToDate","ToDate Succefully Entered","Pass", HtmlOutputFileName,driver);
		 
		 
		 driver.findElement(By.xpath(OR.LE_Comment_sendkey)).sendKeys(Comment);
