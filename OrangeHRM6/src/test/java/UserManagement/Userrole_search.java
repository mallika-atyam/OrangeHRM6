...
public class Userrole_search
{
	...
	public  void Userrole_search(WebDriver driver,String HtmlOutputFileName,TestHTMLReporter6 TH3  )throws Exception
	{  
			  this.driver=driver;
	...
	*/
		  ...
		  ExcelApiTest3 eat = new ExcelApiTest3();
			// int numberowsInputdata=eat.getRowCount("C://HTML Report//OrangeHRM6//TC01_jobtitle.xls","Sheet2");
				 ...
				 {		 
					 UserName="ADMIN";
					 Password="admin123";
					 name=eat.getCellData("C://HTML Report//OrangeHRM6//TC01_users.xls","Sheet1",i,3);
					 System.out.println("User name is"+UserName);
					 System.out.println(" Password is "+Password);
					 System.out.println(" jobtitle is "+name);
	...
	{  
		...
		Userrole_search DJT =new Userrole_search();
		DJT.Userrole_search(driver, HtmlOutputFileName, TH3);		
		
		
		Boolean r1=false;
		r1=DJT.role_search(name);
		if(r1==true)	 
		{
	...
	public   Boolean role_search(String name)throws Exception
	{  
	        			...
	        			ExcelApiTest3 eat = new ExcelApiTest3();
	        			  ...
	        			  for ( int i=1 ; i<=rows.size() ;i++)
	  				    {
	  				    	...
	  				    	System.out.println("name in the excelsheet is " + name);
	  					    	...
	  					    	{
	  					    	   Record_Present=true;
	  					    	   System.out.println("userrole found " + nameinapp + "userrole in  " + i +" rwo" );
	  					    	   
	  					    	 ExcelApiTest3 eat1 = new ExcelApiTest3();
			        			 int rownum1=eat1.getRowCount("C://HTML Report//OrangeHRM6//TC01_users.xls","Sheet2");
			        			  ...
			        			  for ( int j=2 ,k=0; j<=columns.size() ;j++,k++)
						    	   {
						    	      ...
						    	      //  System.out.println("Cell Text Value is: " + valueIneed1);
						    	        ...
						    	        if (valueIneed2 !=null)
						    	        eat1.PutCellData( "C://HTML Report//OrangeHRM6//TC01_users.xls","Sheet2",rownum1,k,valueIneed2);
						    	        else
						    	        eat1.PutCellData( "C://HTML Report//OrangeHRM6//TC01_users.xls","Sheet2",rownum1,k,"Blank Data");
