...
public class name_role_empSearch_click
{
	...
	*/
	...
	{  
		...
		name_role_empSearch_click nre =new name_role_empSearch_click();
	...
	{  
		...
		System.out.println("reached here1");
		 ...
		 TH3.HTMLScreenShot("users","users clicked Succefully ","Pass", HtmlOutputFileName,driver);
		 */
		 System.out.println(" Username in search method is "+name);
		 System.out.println(" Userrole in search method is "+role);
		 System.out.println(" Empname in search method is "+empname);
		 ...
		 driver.findElement(By.xpath(OR.ADMIN_search_btn)).click();
		  TH3.HTMLScreenShot("Admin_search","Admin_search clicked Succefully ","Pass", HtmlOutputFileName,driver);
