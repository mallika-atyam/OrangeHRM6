...
public class users_export
{
	...
	public  void users_export(WebDriver driver,String HtmlOutputFileName,TestHTMLReporter6 TH3  )throws Exception
	{  
			  this.driver=driver;
	...
	/*
	@Test
	public  void user_expo( )throws Exception
	{  
		users_export AL=new users_export();
		AL.Data_driven_test();
	}
	*/
	@Test
	...
	{  
		  ...
		  ExcelApiTest3 eat = new ExcelApiTest3();
			 int numberowsInputdata=eat.getRowCount("C://HTML Report//OrangeHRM6//TC01_users.xls","Sheet1");
				 ...
				 for(int i=1;i<2;i++)
				 {		 
					 UserName=eat.getCellData("C://HTML Report//OrangeHRM6//TC01_users.xls","Sheet1",i,0);
					 Password=eat.getCellData("C://HTML Report//OrangeHRM6//TC01_users.xls","Sheet1",i,1);
	...
	{  
		...
		users_export JE =new users_export();
		JE.users_export(driver, HtmlOutputFileName, TH3);
		JE.userstable_export();
	...
	public   void userstable_export()throws Exception
	{  
		...
		System.out.println("reached here1");
		 ...
		 TH3.HTMLScreenShot("admin usermanagement focus highlight","usermanagement focused Succefully ","Pass", HtmlOutputFileName,driver);
		 
		 driver.findElement(By.xpath(OR.ADMIN_USERS_click)).click();
		 TH3.HTMLScreenShot("users highlight","users highlight Succefully ","Pass", HtmlOutputFileName,driver);
					    	  ...
					    	  for ( int j=2 ,k=0; j<=columns.size() ;j++,k++)
					    	   {
					    	      ...
					    	      //  System.out.println("Cell Text Value is: " + valueIneed1);
					    	        ...
					    	        if (valueIneed1 !=null)
					    	        eat.PutCellData( "C://HTML Report//OrangeHRM6//TC01_users.xls","Sheet5",i,k,valueIneed1);
					    	        else
					    	        eat.PutCellData( "C://HTML Report//OrangeHRM6//TC01_users.xls","Sheet5",i,k,"Blank Data");
