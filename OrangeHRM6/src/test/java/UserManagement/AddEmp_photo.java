...
public class AddEmp_photo
{
	public String UserName,Password;
	public String FirstName,MiddleName,LastName,Id,photo;
	...
	{  
		  ...
		  //int numberowsInputdata=eat.getRowCount("C:\\HTML Report\\OrangeHRM6\\TC01_useradd.xls","Sheet2");
				 ...
				 {		 
					 ...
					 FirstName=eat.getCellData("C:\\HTML Report\\OrangeHRM6\\TC01_useradd.xls","Sheet6",i,0);
					 MiddleName=eat.getCellData("C:\\HTML Report\\OrangeHRM6\\TC01_useradd.xls","Sheet6",i,1);
					 LastName=eat.getCellData("C:\\HTML Report\\OrangeHRM6\\TC01_useradd.xls","Sheet6",i,2);
					 Id=eat.getCellData("C:\\HTML Report\\OrangeHRM6\\TC01_useradd.xls","Sheet6",i,3);
	...
	{  
		...
		AddEmp_photo AE =new AddEmp_photo();
	...
	{  
		...
		System.out.println("reached here1");
		 ...
		 //driver.findElement(By.xpath(OR.photopicker)).sendKeys("D:\\RoopaSri\\roopa1.JPG");
		// WebElement uploadElement = driver.findElement(By.id(OR.photopicker));
		 WebElement uploadElement = driver.findElement(By.xpath(OR.photopicker));
	        // enter the file path onto the file-selection input field
	        uploadElement.sendKeys("D:\\RoopaSri\\roopa1.JPG");
